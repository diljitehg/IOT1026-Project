namespace MinotaurLabyrinth
{
    public class CustomMonster : Monster
    {
        ...
        public override void Activate(Hero hero, Map map)
        {
            const int RowMove = 1;
            const int ColMove = 2;
            ConsoleHelper.WriteLine("You have encountered the custom monster! He charges at you and knocks you into another room.", ConsoleColor.Magenta);
            if (hero.HasSword)
            {
                hero.HasSword = false;
